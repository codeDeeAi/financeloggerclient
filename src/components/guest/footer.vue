  ...
  >
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
      <div class="sm:col-span-2">
        ...
        <div class="mt-6 lg:max-w-sm">
          <p class="text-sm text-gray-800">
            Finance logger is a simple and easy to use personal finance tracker
            that helps users to simple keep track of ther daily income, expenses
            and savings across different accounts
          </p>
        </div>
      </div>
      <div class="space-y-2 text-sm">
        ...
        <div class="flex">
          <p class="mr-1 text-gray-800">Developer:</p>
          <a
        ...
        <div class="flex">
          ...
          <a
            href="https://adeolaabayomi.netlify.app"
            target="_blank"
            ...
            class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
          >
            https://adeolaabayomi.netlify.app
          </a>
        </div>
      </div>
      <div>
    ...
    >
      <p class="text-sm text-gray-600">
        © Copyright {{ new Date().getFullYear() }} <a href="http://linkedin.com/in/adeola-bada-aiism-a51174124">Bada Adeola</a>.
        All rights reserved.
      </p>
      <ul
